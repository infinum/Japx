...
extension Request {
    ...
    public static func serializeResponseCodableJSONAPI<T: Decodable>(response: HTTPURLResponse?, data: Data?, error: Error?, includeList: String?, keyPath: String?, decoder: JadeDecoder) -> Result<T> {
        ...
        do {
            ...
            let json = try Jade.Decoder.jsonObject(with: validData, includeList: includeList)
            guard let jsonForKeyPath = (json as AnyObject).value(forKeyPath: keyPath) else {
                return .failure(JadeAlamofireError.invalidKeyPath(keyPath: keyPath))
            }
...
extension DataRequest {
    ...
    public static func codableJSONAPIResponseSerializer<T: Decodable>(includeList: String?, keyPath: String?, decoder: JadeDecoder) -> DataResponseSerializer<T> {
    ...
    /// - returns: The request.
    @discardableResult
    public func responseCodableJSONAPI<T: Decodable>(queue: DispatchQueue? = nil, includeList: String? = nil, keyPath: String? = nil, decoder: JadeDecoder = JadeDecoder(), completionHandler: @escaping (DataResponse<T>) -> Void) -> Self {
        return response(
            queue: queue,
...
extension DownloadRequest {
    ...
    ///
    /// - returns: A JSON:API object response serializer.
    public static func codableJSONAPIResponseSerializer<T: Decodable>(includeList: String?, keyPath: String?, decoder: JadeDecoder) -> DownloadResponseSerializer<T> {
    ...
    /// - returns: The request.
    @discardableResult
    public func responseCodableJSONAPI<T: Decodable>(queue: DispatchQueue? = nil, includeList: String? = nil, keyPath: String? = nil, decoder: JadeDecoder = JadeDecoder(), completionHandler: @escaping (DownloadResponse<T>) -> Void) -> Self {
        return response(
            queue: queue,
